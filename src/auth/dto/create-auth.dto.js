...
var CreateAuthDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _nombres_decorators = [(0, swagger_1.ApiProperty)({ example: 'Pepito' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _apellidos_decorators = [(0, swagger_1.ApiProperty)({ example: 'Perez' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _correo_decorators = [(0, swagger_1.ApiProperty)({ example: 'pepito-perez@credisur.com' }), (0, class_validator_1.IsEmail)()];
            _password_decorators = [(0, swagger_1.ApiProperty)({
                    example: 'Password123!',
                    minLength: 8,
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8)];
            _rol_decorators = [(0, swagger_1.ApiProperty)({
                    enum: client_1.RolUsuario,
                    example: client_1.RolUsuario.COORDINADOR,
