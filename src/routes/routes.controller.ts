...
export class RoutesController {
  ...
  @Post()
  @Roles(RolUsuario.SUPERVISOR, RolUsuario.COORDINADOR, RolUsuario.SUPER_ADMINISTRADOR)
  ...
  @Get()
  @Roles(RolUsuario.SUPERVISOR, RolUsuario.COORDINADOR, RolUsuario.SUPER_ADMINISTRADOR, RolUsuario.COBRADOR)
  ...
  @ApiResponse({ status: 200, description: 'Lista de cobradores obtenida exitosamente' })
  getCobradores() {
  ...
  @ApiResponse({ status: 404, description: 'Ruta no encontrada' })
  @ApiResponse({ status: 400, description: 'No se puede eliminar una ruta con clientes asignados' })
  ...
  @ApiResponse({ status: 200, description: 'Estado de ruta cambiado exitosamente' })
  @ApiResponse({ status: 404, description: 'Ruta no encontrada' })
  ...
  @ApiResponse({ status: 409, description: 'El cliente ya está asignado a esta ruta' })
  assignClient(
    @Param('id', ParseUUIDPipe) id: string,
  ...
  @ApiResponse({ status: 404, description: 'Ruta o cliente no encontrado' })
  @ApiResponse({ status: 409, description: 'El cliente ya está asignado a la ruta destino' })
  moveClient(
    @Body('clienteId', ParseUUIDPipe) clienteId: string,
