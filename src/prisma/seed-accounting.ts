...
const accounts = [
  ...
  },
  {
    ...
    type: 'INGRESOS',
    nature: 'ACREEDORA',
    description: 'Precio de venta de artículos financiados o de contado',
  },
  // 4. GASTOS
  {
    code: '4',
  ...
  // 5. COSTOS
  {
    ...
    type: 'COSTOS',
    nature: 'DEBITORA',
    description: 'Costos directos asociados a ventas',
  },
  {
    code: '5.1',
    name: 'Costo de Artículos Vendidos',
    type: 'COSTOS',
    nature: 'DEBITORA',
    description: 'Costo de inventario entregado en créditos de artículo',
  },
] as const;
...
main()
  .catch((e) => {
    console.error('❌ Error en el seed contable:', e);
    process.exit(1);
  })
  .finally(async () => {
