-- Ensure registros_visitas exists before adding constraints.
-- This migration intentionally stays idempotent because this repository has
-- legacy non-timestamped migrations whose alphabetical order can run
-- constraints before the original table migration.
...
-- Add unique index for rutaId, clienteId, fechaVisita
CREATE UNIQUE INDEX IF NOT EXISTS "registros_visitas_rutaId_clienteId_fechaVisita_key"
ON "registros_visitas"("rutaId", "clienteId", "fechaVisita");
