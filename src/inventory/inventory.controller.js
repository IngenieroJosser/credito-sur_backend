...
var InventoryController = function () {
    ...
    var _findArchived_decorators;
    var _create_decorators;
    var _exportInventario_decorators;
    ...
    var InventoryController = _classThis = /** @class */ (function () {
        ...
        InventoryController_1.prototype.getInventoryStats = function () {
            return this.inventoryService.getInventoryStats();
        };
        InventoryController_1.prototype.findArchived = function () {
            return this.inventoryService.findArchived();
        };
        InventoryController_1.prototype.create = function (createInventoryDto) {
            return this.inventoryService.create(createInventoryDto);
        };
        InventoryController_1.prototype.exportInventario = function (res, format) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.inventoryService.exportarInventario(format)];
                        case 1:
                            result = _a.sent();
        ...
        InventoryController_1.prototype.findOne = function (id) {
            return this.inventoryService.findOne(id);
        };
        InventoryController_1.prototype.update = function (id, updateInventoryDto) {
            return this.inventoryService.update(id, updateInventoryDto);
        };
        InventoryController_1.prototype.restore = function (id) {
            return this.inventoryService.restore(id);
        };
        InventoryController_1.prototype.hideArchived = function (id) {
            return this.inventoryService.hideArchived(id);
        };
        InventoryController_1.prototype.remove = function (id) {
    ...
    (function () {
        ...
        _findArchived_decorators = [(0, common_1.Get)('archived')];
        _create_decorators = [(0, common_1.Post)()];
        _exportInventario_decorators = [(0, common_1.Get)('export'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _findAll_decorators = [(0, common_1.Get)()];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.Patch)(':id')];
        _restore_decorators = [(0, common_1.Patch)(':id/restore')];
        _hideArchived_decorators = [(0, common_1.Patch)(':id/hide-archived')];
        ...
        __esDecorate(_classThis, null, _findArchived_decorators, { kind: "method", name: "findArchived", static: false, private: false, access: { has: function (obj) { return "findArchived" in obj; }, get: function (obj) { return obj.findArchived; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _create_decorators, { kind: "method", name: "create", static: false, private: false, access: { has: function (obj) { return "create" in obj; }, get: function (obj) { return obj.create; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _exportInventario_decorators, { kind: "method", name: "exportInventario", static: false, private: false, access: { has: function (obj) { return "exportInventario" in obj; }, get: function (obj) { return obj.exportInventario; } }, metadata: _metadata }, null, _instanceExtraInitializers);
