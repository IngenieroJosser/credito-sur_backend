...
async function main() {
    ...
    await crearUsuarioPorRol('ventas@credisur.com', 'Vendedor', 'Principal', client_1.RolUsuario.PUNTO_DE_VENTA, 'Ventas123!');
    await crearUsuarioPorRol('contador@credisur.com', 'Contador', 'General', client_1.RolUsuario.CONTADOR, 'Contador123!');
